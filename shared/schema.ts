...
export const commaxAccounts = pgTable("commax_accounts", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").notNull(),
  platform: text("platform").notNull(), // twitter, instagram, linkedin, facebook, tiktok, youtube, threads, pinterest
...
export const commaxPosts = pgTable("commax_posts", {
  ...
  platforms: text("platforms").array().default([]), // target platforms
  accountIds: integer("account_ids").array().default([]), // target account IDs
  aiGenerated: boolean("ai_generated").default(false),
  prompt: text("prompt"), // original prompt if AI-generated
  tags: text("tags").array().default([]),
  campaignName: text("campaign_name"),
  publishResults: jsonb("publish_results").default({}), // per-platform results after publish
  engagementStats: jsonb("engagement_stats").default({}), // likes, shares, comments etc.
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const commaxMentions = pgTable("commax_mentions", {
  ...
  type: text("type").notNull().default("mention"), // mention, comment, dm, reply
