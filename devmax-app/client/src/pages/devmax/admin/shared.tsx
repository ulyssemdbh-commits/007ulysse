...
import {
  Mail, BookOpen, Music, MessageCircle, Globe, HardDrive, Calendar,
  CreditCard, CheckSquare, Hash, Cpu, Triangle, Database, Phone, Send,
  Cloud, Flame, Link, Plug,
} from "lucide-react";
...
export async function adminFetch(url: string, opts: RequestInit = {}) {
  ...
  return fetch(url, {
    ...opts,
    headers: { ...opts.headers as Record<string, string>, "x-devmax-admin": token || "", "Content-Type": "application/json" },
  });
}
