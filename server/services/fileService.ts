...
async function getExcelJS() {
  if (!_ExcelJS) { try { _ExcelJS = (await import("exceljs")).default; } catch { console.warn("[FileService] exceljs not available"); } }
  return _ExcelJS;
}
let _docxMod: any = null;
async function getDocx() {
  if (!_docxMod) { try { _docxMod = await import("docx"); } catch { console.warn("[FileService] docx not available"); } }
  return _docxMod;
}
let _mammoth: any = null;
async function getMammoth() {
  if (!_mammoth) { try { _mammoth = (await import("mammoth")).default || await import("mammoth"); } catch { console.warn("[FileService] mammoth not available"); } }
  return _mammoth;
}
...
let _archiver: any = null;
async function getArchiver() {
  if (!_archiver) { try { _archiver = (await import("archiver")).default; } catch { console.warn("[FileService] archiver not available"); } }
  return _archiver;
}
let _AdmZip: any = null;
async function getAdmZip() {
  if (!_AdmZip) { try { _AdmZip = (await import("adm-zip")).default; } catch { console.warn("[FileService] adm-zip not available"); } }
  return _AdmZip;
}
