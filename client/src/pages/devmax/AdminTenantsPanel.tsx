...
import {
  Users, FolderGit2, Globe, Plus, Trash2,
  Edit3, Eye, RefreshCw, Lock, CheckCircle2, XCircle,
  ArrowLeft, BarChart3, Building2, Key, Mail,
  UserPlus, CreditCard, Send, Copy,
  Search, ChevronRight, ShieldCheck, Link2, Plug, Power, TestTube,
} from "lucide-react";
import { API, adminFetch, fmt, Spinner, PLAN_COLORS, PLAN_LABELS, CATEGORY_COLORS, STATUS_STYLES } from "./adminShared";

const INTEGRATION_ICONS: Record<string, any> = {
  Mail, Music: Globe, MessageCircle: Globe, Github: Globe, HardDrive: Globe, Calendar: Globe,
  CreditCard, CheckSquare: Globe, Hash: Globe, Cpu: Globe, Triangle: Globe, Database: Globe, Phone: Globe, Send,
  Cloud: Globe, Flame: Globe, Link: Globe,
};
