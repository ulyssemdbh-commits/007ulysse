...
import type { CashEntry } from "../sugu/types";
import { fmt, safeFloat, safeInt, t, fmtDate } from "../sugu/helpers";
import { useSuguDark, Card, StatCard, FormModal, Field, useInputClass, btnPrimary, btnDanger, CardSizeToggle, MiniCalendar } from "./shared";
import {
  Plus,
  Trash2,
  BarChart3,
...
export function CaisseTab({ compactCards, setCompactCards }: { compactCards: boolean; setCompactCards: (v: boolean) => void }) {
