...
export default function Dashboard() {
  ...
  const [pendingFileAnalysis, setPendingFileAnalysis] = useState<{ content: string; fileName: string; imageDataUrl?: string; pdfPageImages?: string[] } | null>(null);
  ...
  const handleSendMessage = useCallback(async (messageText?: string) => {
    ...
    try {
      const res = await fetch(`/api/conversations/${activeConversationId}/messages`, {
        ...
        body: JSON.stringify({ content, imageDataUrl, pdfPageImages }),
          ...
          <form onSubmit={(e) => { e.preventDefault(); handleSend(); }} className="flex items-end gap-3">
            ...
            <FileUpload
              ...
              onFileAnalyzed={(analysis, fileName) => {
                ...
                setPendingFileAnalysis({ content: analysis.content, fileName, imageDataUrl, pdfPageImages });
              }}
            />
            <Button
              type="submit"
