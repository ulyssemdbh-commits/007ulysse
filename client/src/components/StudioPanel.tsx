...
import {
  ...
  Film, Music, Wand2, History, Layers, Eye
} from "lucide-react";
                    ...
                    {canEdit ? (
                      <div className="flex items-end gap-2 max-w-3xl mx-auto">
                        <div className="flex-1">
                          <p className="text-xs text-white/30 mb-1 flex items-center gap-1">
                            ...
                            Demandez à Ulysse de modifier ce fichier
                          </p>
                          <Textarea
                            ref={chatInputRef}
                            value={editPrompt}
                            ...
                            placeholder="Ex: Change le fond en bleu, ajoute du texte en haut..."
                      ...
                      <div className="text-center">
                        <p className="text-xs text-white/30">
                          L'édition interactive est disponible pour les images. Pour les autres types, demandez à Ulysse dans le chat principal.
                        </p>
                      </div>
                    )}
                    {editMutation.isPending && (
